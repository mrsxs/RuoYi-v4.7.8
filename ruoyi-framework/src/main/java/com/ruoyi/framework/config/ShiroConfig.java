...
import com.ruoyi.framework.shiro.realm.StudentRealm;
...
public class ShiroConfig
{
    ...
    @Bean
    public StudentRealm studentRealm(EhCacheManager cacheManager) {
        StudentRealm studentRealm = new StudentRealm();
        studentRealm.setCacheManager(cacheManager);
        return studentRealm;
    }
     ...
     */
    @Bean
    public SecurityManager securityManager(UserRealm userRealm, StudentRealm studentRealm){
        DefaultWebSecurityManager securityManager = new DefaultWebSecurityManager();
        // 设置多个realm.
        securityManager.setRealms(Arrays.asList(userRealm, studentRealm));
        // 记住我
